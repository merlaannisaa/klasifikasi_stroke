...
if menu == "Visualisasi":
    ...
    st.write(f"Jumlah Data Training: {len(resX_train)}")
    ...
    if input_type == "User Input":
        ...
        input_type = st.sidebar.radio("Pilih Jenis Input", ["Data Tanpa Label", "Data Dengan Label"])
        if input_type == "Data Tanpa Label":
